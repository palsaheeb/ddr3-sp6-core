...
xfile add "../rtl/ddr_controller_bank3.vhd"
...
xfile add "ddr_controller_bank3.ucf"
...
project set "Library Search Order" "../synth/ddr_controller_bank3.lso" -process "Synthesize - XST"
