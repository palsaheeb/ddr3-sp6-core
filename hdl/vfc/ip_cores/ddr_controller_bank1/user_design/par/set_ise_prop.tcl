...
xfile add "../rtl/ddr_controller_bank1.vhd"
...
xfile add "ddr_controller_bank1.ucf"
...
project set "Library Search Order" "../synth/ddr_controller_bank1.lso" -process "Synthesize - XST"
